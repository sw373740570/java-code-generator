                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form id="addForm" class="form-horizontal">
                                    ...
                                    <div class="col-sm-10"><input type="text" class="form-control" id="customerName" name="customerName" maxlength="200"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                
									<div class="form-group"><label class="col-sm-2 control-label">客户身份证号码</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" id="customerIdcard" name="customerIdcard" maxlength="200"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                
									<div class="form-group"><label class="col-sm-2 control-label">手机号码</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" id="customerMobile" name="customerMobile" maxlength="200"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                ...
                                <div class="hr-line-dashed"></div>
                                    ...
                                    <div class="col-sm-10"><input type="text" class="form-control" id="recomTime" name="recomTime" maxlength="200"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                
									<div class="form-group"><label class="col-sm-2 control-label">线上销售ID</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" id="onlineSaleId" name="onlineSaleId" maxlength="200"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                
									<div class="form-group"><label class="col-sm-2 control-label">代理人ID</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" id="customerAgentId" name="customerAgentId" maxlength="200"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                
									<div class="form-group"><label class="col-sm-2 control-label">介绍人的邀请码</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" id="introducerInviteCode" name="introducerInviteCode" maxlength="200"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-2">
                                    	<a href="javascript:void(0);" onclick="addLrhCustomer();" class="btn btn-primary" role="button"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span> 保存</button></a>
