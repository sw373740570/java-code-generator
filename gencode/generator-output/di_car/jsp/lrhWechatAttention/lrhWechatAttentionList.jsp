                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
	                    	<div style="float:left;">
								...
								<input type="text" class="form-control" style="width:300px; float:left; " id="wechatNo" name="wechatNo" placeholder="客户微信号"
								...
								<input type="text" class="form-control" style="width:300px; float:left; " id="vbsSaleRegionKey" name="vbsSaleRegionKey" placeholder="VBS——销售所属城市代码"
	                    			onkeypress="enterPress(event)" onkeydown="enterPress()" />&nbsp;&nbsp;
								<input type="text" class="form-control" style="width:300px; float:left; " id="openId" name="openId" placeholder="客户微信OpenID"
	                    			onkeypress="enterPress(event)" onkeydown="enterPress()" />&nbsp;&nbsp;
								<input type="text" class="form-control" style="width:300px; float:left; " id="attentionTime" name="attentionTime" placeholder="关注时间"
	                    			onkeypress="enterPress(event)" onkeydown="enterPress()" />&nbsp;&nbsp;
								<input type="text" class="form-control" style="width:300px; float:left; " id="createTime" name="createTime" placeholder="记录创建时间"
	                    			onkeypress="enterPress(event)" onkeydown="enterPress()" />&nbsp;&nbsp;
								<input type="text" class="form-control" style="width:300px; float:left; " id="modifyTime" name="modifyTime" placeholder="记录更新时间"
	                    			onkeypress="enterPress(event)" onkeydown="enterPress()" />&nbsp;&nbsp;
